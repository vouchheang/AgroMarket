          ...
          <div class="box">
            <div class="inner-box">
              <div class="image-box">
                ...
                <img src="${products[i].attributes.images.data[0]?.attributes.formats.thumbnail.url}" class="card-img-top" alt="Image">
                    ${products[i].attributes.Origanic ? '<span class="badge organic-badge" style="position: absolute;  top: 10px;right: 10px;  background-color: #ffd700;  color: #006400;  padding: 5px 10px;border-radius: 5px;">Organic</span>' : ''}
              </div>
              <div class="text-box">
